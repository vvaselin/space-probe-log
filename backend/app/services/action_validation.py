...
def validate_action(db: Session, probe: Probe, proposed: ProposedAction) -> ValidationResult:
    ...
    if proposed.action == "wait":
        return ValidationResult(proposed, "accepted", "待機可能です。")
    if proposed.action == "move":
        ...
        return ValidationResult(proposed, "accepted", "移動可能です。")
    if proposed.action == "observe":
        ...
        return ValidationResult(proposed, "accepted", "観測可能です。")
    ...
    if proposed.action == "collect_resource":
        ...
        return ValidationResult(proposed, "accepted", "資源採取可能です。")
